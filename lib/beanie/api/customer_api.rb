...
module Beanie
  class CustomerApi
    ...
    # @return [Customer]
    def add_customer(customers, opts = {})
    ...
    def add_customer_with_http_info(customers, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [Customer]
    def find_customer_by_id(id, opts = {})
      data, _status_code, _headers = find_customer_by_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Customer, Fixnum, Hash)>] Customer data, response status code and response headers
    def find_customer_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomerApi.find_customer_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomerApi.find_customer_by_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Customer')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomerApi#find_customer_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # All customer
